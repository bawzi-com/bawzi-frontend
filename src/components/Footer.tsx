...
export default function Footer() {
  ...
  return (
    <footer className="bg-white text-slate-500 relative overflow-hidden border-t border-slate-200/60">
      ...
      <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-emerald-500 via-sky-500 to-emerald-500 opacity-80"></div>
      ...
      <div className="max-w-[1400px] mx-auto px-6 py-12 md:py-16 grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        <div className="md:col-span-2">
          ...
          <p className="text-slate-500 text-sm leading-relaxed max-w-sm mb-6 font-medium">
            ...
            Decida com mais clareza quando vale entrar em uma licitação e quais riscos merecem atenção.
          </p>
          
          <div className="flex gap-3">
            {/* Ícone LinkedIn */}
            <a href="#" className="w-10 h-10 rounded-xl bg-slate-50 border border-slate-100 text-slate-400 flex items-center justify-center hover:bg-emerald-600 hover:text-white hover:-translate-y-1 hover:shadow-lg hover:shadow-emerald-600/20 transition-all duration-300">
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/></svg>
            </a>
            {/* Ícone Instagram */}
            <a href="#" className="w-10 h-10 rounded-xl bg-slate-50 border border-slate-100 text-slate-400 flex items-center justify-center hover:bg-sky-600 hover:text-white hover:-translate-y-1 hover:shadow-lg hover:shadow-sky-600/20 transition-all duration-300">
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm font-medium">
            <li><Link href="/#planos" className="hover:text-emerald-700 transition-colors">Planos e preços</Link></li>
            <li><Link href="/workspace" className="hover:text-emerald-700 transition-colors">Nova análise</Link></li>
            <li><Link href="/history" className="hover:text-emerald-700 transition-colors">Meu histórico</Link></li>
            <li>
              <Link href="/enterprise" className="group flex items-center gap-2 hover:text-emerald-700 transition-colors">
                API Enterprise 
                <span className="bg-emerald-50 text-emerald-700 text-[9px] font-bold px-2 py-0.5 rounded-full group-hover:bg-emerald-600 group-hover:text-white transition-colors">Novo</span>
              </Link>
            </li>
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm font-medium">
            ...
            <li><Link href="/privacidade" className="hover:text-emerald-700 transition-colors">Aviso de privacidade</Link></li>
      ...
      <div className="max-w-[1400px] mx-auto px-6 py-6 border-t border-slate-100 flex flex-col md:flex-row justify-between items-center gap-4">
        ...
        <p className="text-xs font-medium text-slate-400 flex items-center gap-1.5">
          Feito para empresas que querem decidir melhor.
        </p>
      </div>
